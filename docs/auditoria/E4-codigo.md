...
- **Para E3 (UX):** la decisión sobre `implicitas-panel.tsx`/`sample.ts` (hallazgo #15) es prerequisito
  de este hallazgo — E4 no puede resolverlo unilateralmente.

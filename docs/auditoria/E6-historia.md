...
1. `CONTEXTO.md` → reemplazar toda la sección `## Pendientes (lista canónica — actualizada 09/07/2026)`
   por 2-3 líneas: *"El backlog vivo vive en `ESTADO.md` («Plan ROFO AGRO») y su mapeo completo con
...
3. `ESTADO.md` → el backlog «Plan ROFO AGRO» (bloques 1-4) queda como el ÚNICO checklist vivo con

...
| E2 | Fórmulas y lógica de negocio | **fase 1 hecha** (informe listo, esperando OK hallazgo por hallazgo) | `auditoria/E2-formulas.md` (+ anexo `E2-formulas-fichas.md`, 45 fichas) | #_ |

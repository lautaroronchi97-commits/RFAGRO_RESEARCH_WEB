...
| 6 | Sintéticos/LECAPs | **REAL** (`market/sinteticos.ts` + `sinteticos.ts` puro): sintético = spot×(pagoFinal/px), directa, TNA act/365; empareja letra↔DLR por mismo mes; compara vs futuro directo. Precio LECAP de data912; **pago final** por carga semi-manual en `/admin/datos` (tabla `lecap_pago_final`, fuente última BYMA, casi estático). C13/P9, `sesiones/2026-07-24-c13-sinteticos-tir.md`. |

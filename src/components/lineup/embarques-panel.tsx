  ...
  return (
    <Panel id="comercio-embarques">
      ...
      <QueEsEsto
        ...
        comoSeCalcula="El declarado sale del registro público de DJVE (SAGyP), tomando la ventana de embarque que declara cada operación: por norma el granel declara períodos de 30 días, así que el mes es un dato preciso (las ventanas de ~90 días son carga en contenedores, el 0,3% del tonelaje, y se excluyen). La opción 30 es el disponible (la ventana arranca el día del registro); la opción 360 es el forward (que además obliga a pagar el 90% de los derechos a los 5 días hábiles: es compromiso caro, no un registro gratis). El line-up de buques solo anticipa ~10 días, por eso los meses lejanos no se cruzan contra barcos. Ojo: el ritmo de DJVE se distorsiona alrededor de los cambios de retenciones (ver decretos 682/2025 y 423/2026)."
      />
    </Panel>
  );
}
